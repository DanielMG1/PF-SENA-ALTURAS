...
<div class="container my-5">
        <div class="row">
            <div class="col">
                <div class="card mb-3">
                    <img src="https://image.freepik.com/foto-gratis/trabajador-ganchos-arnes-seguridad_61243-481.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h3 class="card-title">Equipo Alturas</h3>
                            <div class="row">
                                <div class="col-sm">
                                    <h5>Nombre:</h5>
